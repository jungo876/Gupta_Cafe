      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 md:pr-10 mb-10 md:mb-0">
            <h2 className="text-3xl md:text-4xl font-['Playfair_Display'] font-bold mb-6 text-brown-600">Get In Touch</h2>
            <p className="text-brown-500 mb-8">
              Have questions or feedback? We'd love to hear from you. Reach out to us using the contact form or visit one of our locations.
            </p>

            <div className="mb-8">
              <h3 className="text-xl font-['Playfair_Display'] font-semibold mb-4 text-brown-600">Find Us</h3>
              <div className="flex items-start mb-4">
                <i className="fas fa-map-marker-alt text-orange-400 mt-1 mr-4"></i>
                <div>
                  <p className="text-brown-500">123 Coffee Lane,</p>
                  <p className="text-brown-500">Brewville, CA 94123</p>
                </div>
              </div>
              <div className="flex items-start mb-4">
                <i className="fas fa-phone-alt text-orange-400 mt-1 mr-4"></i>
                <p className="text-brown-500">(555) 123-4567</p>
              </div>
              <div className="flex items-start">
                <i className="fas fa-envelope text-orange-400 mt-1 mr-4"></i>
                <p className="text-brown-500">hello@brewhaven.com</p>
              </div>
            </div>
          ...
          <div className="md:w-1/2">
            <div className="bg-cream p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-['Playfair_Display'] font-bold mb-6 text-brown-600">Send Us a Message</h3>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-brown-500">Subject</FormLabel>
                        <FormControl>
                          <Input placeholder="Subject" {...field} className="text-brown-600" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-brown-500">Message</FormLabel>
                        <FormControl>
                          <Textarea 
